...
const data: NavMenu = [
  {
    id: 1, label: "Chemicals", type: "MenuList",
    children: [
      { id: 11, label: "All Purpose Cleaners", url: "/shop/category/cleaning-chemicals", description: "" },
      { id: 12, label: "Disinfectants", url: "/shop/category/disinfectants", description: "" },
      { id: 13, label: "Degreasers", url: "/shop/category/degreasers", description: "" },
    ],
  },
  {
    id: 2, label: "Cleaning Supplies", type: "MenuList",
    children: [
      { id: 21, label: "Mops & Buckets", url: "/shop/category/floor-care", description: "" },
      { id: 22, label: "Brushes & Sponges", url: "/shop/category/brushes", description: "" },
    ],
  },
  {
    id: 3, label: "Cleaning Equipment", type: "MenuList",
    children: [
      { id: 31, label: "Vacuum Cleaners", url: "/shop/category/equipment", description: "" },
      { id: 32, label: "Floor Machines", url: "/shop/category/floor-machines", description: "" },
    ],
  },
  {
    id: 4, label: "Office Supplies", type: "MenuList",
    children: [
      { id: 41, label: "Paper Products", url: "/shop/category/paper-products", description: "" },
      { id: 42, label: "Dispensers", url: "/shop/category/dispensers", description: "" },
    ],
  },
  { id: 5, label: "Shop By Brands", type: "MenuList", children: [
    { id: 51, label: "Ecolab", url: "/shop?brand=ecolab", description: "" },
    { id: 52, label: "Clorox", url: "/shop?brand=clorox", description: "" },
  ]},
  { id: 6, type: "MenuItem", label: "About Us", url: "/about", children: [] },
  { id: 7, type: "MenuItem", label: "Blog", url: "/blog", children: [] },
  { id: 8, type: "MenuItem", label: "Contact", url: "/contact", children: [] },
];
      ...
      <div className="border-b border-gray-100">
        <div className="max-w-frame mx-auto px-4 xl:px-0 py-3 flex items-center justify-between gap-6">
          ...
          <p className="hidden lg:block text-sm text-gray-500">
            <span className="font-semibold text-gray-800">CALL</span> 08002 420 15
          </p>
      ...
      <div className="hidden md:block bg-white border-b border-gray-100">
        <div className="max-w-frame mx-auto px-4 xl:px-0 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 py-3 text-sm">
            ...
            <span className="font-bold text-gray-800">08002 420 15</span>
          </div>
        </div>
      </div>
    </nav>
